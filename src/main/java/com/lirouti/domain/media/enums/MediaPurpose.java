...
public enum MediaPurpose {
    ...
    CHALLENGE_VERIFICATION("challenge-verifications", Set.of(MediaCategory.IMAGE), true),
    // 그 방 멤버 전원만, 본인만 볼 수 있다. 버킷 정책이 열려 있지 않아 서명으로만 열린다.
    GROUP_ROUTINE_VERIFICATION("group-routine-verifications", Set.of(MediaCategory.IMAGE), false),
    MEMBER_ROUTINE_VERIFICATION("member-routine-verifications", Set.of(MediaCategory.IMAGE), false),
    ...
    PROFILE("profiles", Set.of(MediaCategory.IMAGE), false);
