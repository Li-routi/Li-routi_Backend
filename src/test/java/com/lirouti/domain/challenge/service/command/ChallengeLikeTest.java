...
class ChallengeLikeTest {
    ...
    void feed_CarriesLikeCountAndLiked() {
        ...
        // 누른 사람에게는 liked=true
        ChallengeResDTO.FeedItem forLiker = challengeQueryService
        ...
        ChallengeResDTO.FeedItem forAuthor = challengeQueryService
